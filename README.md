...
<body>
  <script>
    ...
    var defs = {}
            defs["AllOfAuthEmailPerevalCoords"] = {
  "readOnly" : true,
  "allOf" : [ {
    "$ref" : "#/components/schemas/Nested"
  } ]
};
            defs["AllOfPatchedPerevalDetailCoords"] = {
  "readOnly" : true,
  "allOf" : [ {
    "$ref" : "#/components/schemas/Nested"
  } ]
};
            defs["AllOfPatchedPerevalDetailUser"] = {
  "readOnly" : true,
  "allOf" : [ {
    "$ref" : "#/components/schemas/Nested"
  } ]
};
            defs["AllOfPerevalDetailCoords"] = {
  "readOnly" : true,
  "allOf" : [ {
    "$ref" : "#/components/schemas/Nested"
  } ]
};
            defs["AllOfPerevalDetailUser"] = {
  "readOnly" : true,
  "allOf" : [ {
    "$ref" : "#/components/schemas/Nested"
  } ]
};
            defs["AuthEmailPereval"] = {
  "required" : [ "add_time", "beauty_title", "coords", "other_titles", "title" ],
  "type" : "object",
  "properties" : {
    "beauty_title" : {
      "maxLength" : 254,
    ...
    "level_winter" : {
      "title" : "Сложность зимой",
      "maxLength" : 254,
      "type" : "string"
    },
    "level_summer" : {
      "title" : "Сложность летом",
      "maxLength" : 254,
      "type" : "string"
    },
    "level_autumn" : {
      "title" : "Сложность осенью",
      "maxLength" : 254,
      "type" : "string"
    },
    "level_spring" : {
      "title" : "Сложность весной",
      "maxLength" : 254,
      "type" : "string"
    }
  }
  ...
  "description" : "Сериализатор перевала(детальный)"
};
            defs["PerevalAdd"] = {
  "required" : [ "add_time", "beauty_title", "coords", "other_titles", "title", "user" ],
  "type" : "object",
  "properties" : {
    "beauty_title" : {
      "maxLength" : 254,
  ...
  "description" : "Сериализатор перевалов"
};
            defs["PerevalDetail"] = {
  "required" : [ "add_time", "beauty_title", "coords", "id", "other_titles", "title", "user" ],
  "type" : "object",
  "properties" : {
    "id" : {
      "type" : "integer",
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Schema"><a href="#api-Schema">API Methods - Schema</a></li>
                    <li data-group="Schema" data-name="schemaRetrieve" class="">
                      <a href="#api-Schema-schemaRetrieve">schemaRetrieve</a>
                    </li>
                  <li class="nav-header" data-group="SubmitData"><a href="#api-SubmitData">API Methods - SubmitData</a></li>
                    <li data-group="SubmitData" data-name="submitDataCreate" class="">
                      <a href="#api-SubmitData-submitDataCreate">submitDataCreate</a>
                    </li>
                    <li data-group="SubmitData" data-name="submitDataPartialUpdate" class="">
                      <a href="#api-SubmitData-submitDataPartialUpdate">submitDataPartialUpdate</a>
                    </li>
                    <li data-group="SubmitData" data-name="submitDataRetrieve" class="">
                      <a href="#api-SubmitData-submitDataRetrieve">submitDataRetrieve</a>
                    </li>
                    <li data-group="SubmitData" data-name="submitDataUserEmail&#x3D;List" class="">
                      <a href="#api-SubmitData-submitDataUserEmail&#x3D;List">submitDataUserEmail&#x3D;List</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>API мобильного приложения Федерации Спортивного Туризма России (ФСТР) с помощью Django Rest Framework.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Schema">
                  <h1>Schema</h1>
                    <div id="api-Schema-schemaRetrieve">
                      <article id="api-Schema-schemaRetrieve-0" data-group="User" data-name="schemaRetrieve" data-version="0">
                        <div class="pull-left">
                          <h1>schemaRetrieve</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">OpenApi3 schema for this API. Format can be selected via content negotiation.

- YAML: application/vnd.oai.openapi
- JSON: application/vnd.oai.openapi+json</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/schema/</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Schema-schemaRetrieve-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-java">Java</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Schema-schemaRetrieve-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Schema-schemaRetrieve-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Schema-schemaRetrieve-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Schema-schemaRetrieve-0-curl">
...
"//schema/?format=&lang="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-java">
...
public class SchemaApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            map['String', null] result = apiInstance.schemaRetrieve(format, lang);
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SchemaApi;
...
public class SchemaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-objc">
...
[apiInstance schemaRetrieveWith:format
    lang:lang
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var PerevalApi = require('pereval_api');
var defaultClient = PerevalApi.ApiClient.instance;
// Configure HTTP basic authorization: basicAuth
...
var api = new PerevalApi.SchemaApi()
var opts = { 
...
api.schemaRetrieve(opts, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Schema-schemaRetrieve-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-csharp">
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling SchemaApi.schemaRetrieve: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-php">
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-perl">
...
if ($@) {
    warn "Exception when calling SchemaApi->schemaRetrieve: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Schema-schemaRetrieve-0-python">
...
try: 
    ...
    print("Exception when calling SchemaApi->schemaRetrieve: %s\n" % e)</code></pre>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">format</td>
                                <td>
                                
                                
                                    <div id="d2e199_schemaRetrieve_format">
                                ...
                                <tr><td style="width:150px;">lang</td>
                                <td>
                                
                                
                                    <div id="d2e199_schemaRetrieve_lang">
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-schemaRetrieve-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-schemaRetrieve-200-schema">
                                  <div id='responses-schemaRetrieve-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "",
    ...
    "application/json" : {
      "schema" : {
        ...
        "additionalProperties" : { }
                                        ...
                                        var schema = schemaWrapper.content["application/vnd.oai.openapi"].schema;
                                        if (schema.$ref != null) {
                                        ...
                                        $('#responses-schemaRetrieve-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-schemaRetrieve-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-schemaRetrieve-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-SubmitData">
                  <h1>SubmitData</h1>
                    <div id="api-SubmitData-submitDataCreate">
                      <article id="api-SubmitData-submitDataCreate-0" data-group="User" data-name="submitDataCreate" data-version="0">
                        <div class="pull-left">
                          <h1>submitDataCreate</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Переопределение метода POST</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/submitData</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SubmitData-submitDataCreate-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-java">Java</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataCreate-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataCreate-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataCreate-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SubmitData-submitDataCreate-0-curl">
...
"//submitData?"</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SubmitDataApi;

import java.io.File;
import java.util.*;

public class SubmitDataApiExample {
    ...
    public static void main(String[] args) {
        ...
        SubmitDataApi apiInstance = new SubmitDataApi();
        PerevalAdd body = ; // PerevalAdd | 
        try {
            PerevalAdd result = apiInstance.submitDataCreate(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SubmitDataApi#submitDataCreate");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
// Configure HTTP basic authorization (authentication scheme: basicAuth)
[apiConfig setUsername:@"YOUR_USERNAME"];
[apiConfig setPassword:@"YOUR_PASSWORD"];
...
SubmitDataApi *apiInstance = [[SubmitDataApi alloc] init];

[apiInstance submitDataCreateWith:body
              completionHandler: ^(PerevalAdd output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var PerevalApi = require('pereval_api');
var defaultClient = PerevalApi.ApiClient.instance;
// Configure HTTP basic authorization: basicAuth
var basicAuth = defaultClient.authentications['basicAuth'];
...
var api = new PerevalApi.SubmitDataApi()
var body = ; // {{PerevalAdd}} 
...
api.submitDataCreate(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class submitDataCreateExample
    {
        public void main()
        {
            // Configure HTTP basic authorization: basicAuth
            ...
            var apiInstance = new SubmitDataApi();
            var body = new PerevalAdd(); // PerevalAdd | 
            ...
            {
                Debug.Print("Exception when calling SubmitDataApi.submitDataCreate: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
// Configure HTTP basic authorization: basicAuth
Swagger\Client\Configuration::getDefaultConfiguration()->setUsername('YOUR_USERNAME');
...
$api_instance = new Swagger\Client\ApiSubmitDataApi();
$body = ; // PerevalAdd | 

try {
    $result = $api_instance->submitDataCreate($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubmitDataApi->submitDataCreate: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SubmitDataApi;
# Configure HTTP basic authorization: basicAuth
$WWW::SwaggerClient::Configuration::username = 'YOUR_USERNAME';
$WWW::SwaggerClient::Configuration::password = 'YOUR_PASSWORD';
# Configure API key authorization: cookieAuth
...
my $api_instance = WWW::SwaggerClient::SubmitDataApi->new();
my $body = WWW::SwaggerClient::Object::PerevalAdd->new(); # PerevalAdd | 

eval { 
    my $result = $api_instance->submitDataCreate(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SubmitDataApi->submitDataCreate: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataCreate-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.SubmitDataApi()
body =  # PerevalAdd | 

try: 
    api_response = api_instance.submit_data_create(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SubmitDataApi->submitDataCreate: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PerevalAdd"
      }
    },
  ...
  "required" : true
                                  ...
                                  var result = $('#d2e199_submitDataCreate_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_submitDataCreate_body"></div>
                                </td>
                                </tr>
                            </table>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <th>Description</th>
                                  ...
                                  <tr><td style="width:150px;">beauty_title*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_beautyTitle">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataCreate_title">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">other_titles*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_otherTitles">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">connect*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_connect">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">add_time*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_addTime">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Date
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataCreate_user">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
                                  ...
                                  <tr><td style="width:150px;">coords*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_coords">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
                                  ...
                                  <tr><td style="width:150px;">level_winter*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_levelWinter">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">level_summer*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_levelSummer">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">level_autumn*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_levelAutumn">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <tr><td style="width:150px;">level_spring*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_submitDataCreate_levelSpring">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-submitDataCreate-201-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-submitDataCreate-201-schema">
                                  <div id='responses-submitDataCreate-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PerevalAdd"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-submitDataCreate-201-schema-data').val(stringify(schema));
                                        var result = $('#responses-submitDataCreate-201-schema-201');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-submitDataCreate-201-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-SubmitData-submitDataPartialUpdate">
                      <article id="api-SubmitData-submitDataPartialUpdate-0" data-group="User" data-name="submitDataPartialUpdate" data-version="0">
                        <div class="pull-left">
                          <h1>submitDataPartialUpdate</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Класс работы с БД для второго спринта: редактирование перевала</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="patch"><code><span class="pln">/submitData/{id}/</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SubmitData-submitDataPartialUpdate-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-java">Java</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataPartialUpdate-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SubmitData-submitDataPartialUpdate-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X PATCH\
 -H "Authorization: Basic [[basicHash]]"\
\
-H "Accept: application/json"\
-H "Content-Type: application/json,application/x-www-form-urlencoded,multipart/form-data"\
"//submitData/{id}/?"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
    ...
    public static void main(String[] args) {
        ...
        PatchedPerevalDetail body = ; // PatchedPerevalDetail | 
        try {
            PerevalDetail result = apiInstance.submitDataPartialUpdate(id, body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SubmitDataApi#submitDataPartialUpdate");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
// Configure HTTP basic authorization (authentication scheme: basicAuth)
[apiConfig setUsername:@"YOUR_USERNAME"];
[apiConfig setPassword:@"YOUR_PASSWORD"];
...
//[apiConfig setApiKeyPrefix:@"Bearer" forApiKeyIdentifier:@"sessionid"];
Integer *id = 56; // 
PatchedPerevalDetail *body = ; //  (optional)

SubmitDataApi *apiInstance = [[SubmitDataApi alloc] init];

[apiInstance submitDataPartialUpdateWith:id
    body:body
              completionHandler: ^(PerevalDetail output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var PerevalApi = require('pereval_api');
var defaultClient = PerevalApi.ApiClient.instance;
// Configure HTTP basic authorization: basicAuth
var basicAuth = defaultClient.authentications['basicAuth'];
...
api.submitDataPartialUpdate(id, opts, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class submitDataPartialUpdateExample
    {
        public void main()
        {
            // Configure HTTP basic authorization: basicAuth
            ...
            var apiInstance = new SubmitDataApi();
            var id = 56;  // Integer | 
            var body = new PatchedPerevalDetail(); // PatchedPerevalDetail |  (optional) 
            ...
            {
                Debug.Print("Exception when calling SubmitDataApi.submitDataPartialUpdate: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
// Configure HTTP basic authorization: basicAuth
Swagger\Client\Configuration::getDefaultConfiguration()->setUsername('YOUR_USERNAME');
...
try {
    $result = $api_instance->submitDataPartialUpdate($id, $body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubmitDataApi->submitDataPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SubmitDataApi;
# Configure HTTP basic authorization: basicAuth
...
my $api_instance = WWW::SwaggerClient::SubmitDataApi->new();
my $id = 56; # Integer | 
my $body = WWW::SwaggerClient::Object::PatchedPerevalDetail->new(); # PatchedPerevalDetail | 

eval { 
    my $result = $api_instance->submitDataPartialUpdate(id => $id, body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SubmitDataApi->submitDataPartialUpdate: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataPartialUpdate-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
api_instance = swagger_client.SubmitDataApi()
id = 56 # Integer | 
body =  # PatchedPerevalDetail |  (optional)

try: 
    api_response = api_instance.submit_data_partial_update(id, body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SubmitDataApi->submitDataPartialUpdate: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_id">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
  ...
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PatchedPerevalDetail"
      }
    },
    "application/x-www-form-urlencoded" : {
      "schema" : {
    ...
    "multipart/form-data" : {
      "schema" : {
        "$ref" : "#/components/schemas/PatchedPerevalDetail"
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_submitDataPartialUpdate_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_submitDataPartialUpdate_body"></div>
                                </td>
                                </tr>
                            </table>
                              ...
                              <tr>
                                ...
                                <th>Description</th>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_status">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      StatusEnum
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_beautyTitle">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_title">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_otherTitles">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_connect">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_addTime">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Date
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_levelSpring">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_levelSummer">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_levelAutumn">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_levelWinter">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_user">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataPartialUpdate_coords">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-submitDataPartialUpdate-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-submitDataPartialUpdate-200-schema">
                                  <div id='responses-submitDataPartialUpdate-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PerevalDetail"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-submitDataPartialUpdate-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-submitDataPartialUpdate-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-submitDataPartialUpdate-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-SubmitData-submitDataRetrieve">
                      <article id="api-SubmitData-submitDataRetrieve-0" data-group="User" data-name="submitDataRetrieve" data-version="0">
                        <div class="pull-left">
                          <h1>submitDataRetrieve</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Класс работы с БД для второго спринта: извлечение детальной информации о перевале</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/submitData/{id}/</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SubmitData-submitDataRetrieve-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-java">Java</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataRetrieve-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SubmitData-submitDataRetrieve-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Basic [[basicHash]]"\
\
-H "Accept: application/json"\
"//submitData/{id}/?"</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
    ...
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | 
        try {
            PerevalDetail result = apiInstance.submitDataRetrieve(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SubmitDataApi#submitDataRetrieve");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
// Configure HTTP basic authorization (authentication scheme: basicAuth)
[apiConfig setUsername:@"YOUR_USERNAME"];
[apiConfig setPassword:@"YOUR_PASSWORD"];
...
[apiInstance submitDataRetrieveWith:id
              completionHandler: ^(PerevalDetail output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var PerevalApi = require('pereval_api');
var defaultClient = PerevalApi.ApiClient.instance;
// Configure HTTP basic authorization: basicAuth
var basicAuth = defaultClient.authentications['basicAuth'];
...
api.submitDataRetrieve(id, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class submitDataRetrieveExample
    {
        public void main()
        {
            // Configure HTTP basic authorization: basicAuth
            ...
            {
                Debug.Print("Exception when calling SubmitDataApi.submitDataRetrieve: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
// Configure HTTP basic authorization: basicAuth
Swagger\Client\Configuration::getDefaultConfiguration()->setUsername('YOUR_USERNAME');
...
try {
    $result = $api_instance->submitDataRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubmitDataApi->submitDataRetrieve: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SubmitDataApi;
# Configure HTTP basic authorization: basicAuth
...
eval { 
    my $result = $api_instance->submitDataRetrieve(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SubmitDataApi->submitDataRetrieve: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataRetrieve-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    api_response = api_instance.submit_data_retrieve(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SubmitDataApi->submitDataRetrieve: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataRetrieve_id">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-submitDataRetrieve-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-submitDataRetrieve-200-schema">
                                  <div id='responses-submitDataRetrieve-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "",
    ...
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/PerevalDetail"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-submitDataRetrieve-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-submitDataRetrieve-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-submitDataRetrieve-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-SubmitData-submitDataUserEmail&#x3D;List">
                      <article id="api-SubmitData-submitDataUserEmail&#x3D;List-0" data-group="User" data-name="submitDataUserEmail&#x3D;List" data-version="0">
                        <div class="pull-left">
                          <h1>submitDataUserEmail&#x3D;List</h1>
                          <p></p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Класс работы с БД для второго спринта: вывод всех записей по email</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/submitData/user__email&#x3D;{email}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-java">Java</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SubmitData-submitDataUserEmail&#x3D;List-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Basic [[basicHash]]"\
\
-H "Accept: application/json"\
"//submitData/user__email&#x3D;{email}?"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            array[AuthEmailPereval] result = apiInstance.submitDataUserEmail=List(email);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SubmitDataApi#submitDataUserEmail=List");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SubmitDataApi;
...
public class SubmitDataApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
// Configure HTTP basic authorization (authentication scheme: basicAuth)
[apiConfig setUsername:@"YOUR_USERNAME"];
[apiConfig setPassword:@"YOUR_PASSWORD"];
...
[apiInstance submitDataUserEmail&#x3D;ListWith:email
              completionHandler: ^(array[AuthEmailPereval] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var PerevalApi = require('pereval_api');
var defaultClient = PerevalApi.ApiClient.instance;
// Configure HTTP basic authorization: basicAuth
var basicAuth = defaultClient.authentications['basicAuth'];
...
api.submitDataUserEmail=List(email, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class submitDataUserEmail&#x3D;ListExample
    {
        public void main()
        {
            // Configure HTTP basic authorization: basicAuth
            ...
            {
                Debug.Print("Exception when calling SubmitDataApi.submitDataUserEmail&#x3D;List: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
// Configure HTTP basic authorization: basicAuth
Swagger\Client\Configuration::getDefaultConfiguration()->setUsername('YOUR_USERNAME');
...
try {
    $result = $api_instance->submitDataUserEmail=List($email);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SubmitDataApi->submitDataUserEmail&#x3D;List: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SubmitDataApi;
# Configure HTTP basic authorization: basicAuth
...
eval { 
    my $result = $api_instance->submitDataUserEmail=List(email => $email);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SubmitDataApi->submitDataUserEmail&#x3D;List: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SubmitData-submitDataUserEmail&#x3D;List-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    api_response = api_instance.submit_data_user_email=list(email)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SubmitDataApi->submitDataUserEmail&#x3D;List: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_submitDataUserEmail&#x3D;List_email">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-submitDataUserEmail&#x3D;List-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-submitDataUserEmail&#x3D;List-200-schema">
                                  <div id='responses-submitDataUserEmail&#x3D;List-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "",
  "content" : {
    "application/json" : {
      "schema" : {
        "type" : "array",
        "items" : {
          "$ref" : "#/components/schemas/AuthEmailPereval"
        },
        "x-content-type" : "application/json"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-submitDataUserEmail&#x3D;List-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-submitDataUserEmail&#x3D;List-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-submitDataUserEmail&#x3D;List-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
